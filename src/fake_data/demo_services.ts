...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the E-Fonenana service.", fields: {} },
    restart: { description: "Restart the E-Fonenana service.", fields: {} },
    check_config: {
      description:
        "Check the E-Fonenana configuration files for errors. Errors will be displayed in the E-Fonenana log.",
      fields: {},
    },
    update_entity: {
